...
import { CommitConditionalUpertsProps, CommitConditionalUpsertWithVarsProps, CommitQueryWithVarsProps } from './models/db.model'
@Injectable()
export class DbService {
  private readonly dgraphStub: DgraphClientStub
  private readonly dgraph: DgraphClient
  constructor () {
    this.dgraphStub = new DgraphClientStub("s18.onism.cc:9080")
